...
#   make_option(c('--number_mgPerCellType'), help = "number of markers per cell type", default = c(20, 20, 20, 20)),
#   make_option(c('--cellTypesToCorrectFor'), help = "cell types to correct for", default = c("ast", "mic", "neu", "oli"))
# )
# 
...
# 
# br <- opt$br
# numMarkersPerCellType <- opt$number_mgPerCellType # c(20, 20, 20, 20)
# cellTypesToCorrectFor < - opt$cellTypesToCorrectFor # c("ast", "mic", "neu", "oli")

# numMarkersPerCellType <- c(20, 20, 20, 20)
# cellTypesToCorrectFor < - c("ast", "mic", "neu", "oli")
...
readCellTypeFreq <- function(BR, whichBR, condition){
  file <- read.csv(paste("results/", BR[whichBR], "_CellCODE_80mg_4cellTypes_", BR[1], BR[2], "_", 
...
BM10_spv <- get_SPV_BrainRegion("BM_10", MarkerGenes = mg)
write.csv(BM10_spv,
          paste("results/", "BM10_CellCODE_80mg_4cellTypes.csv", sep = ""))

BM22_spv <- get_SPV_BrainRegion("BM_22", MarkerGenes = mg)
write.csv(BM22_spv,
          paste("results/", "BM22_CellCODE_80mg_4cellTypes.csv", sep = ""))

BM36_spv <- get_SPV_BrainRegion("BM_36", MarkerGenes = mg)
write.csv(BM36_spv,
          paste("results/", "BM36_CellCODE_80mg_4cellTypes.csv", sep = ""))

BM44_spv <- get_SPV_BrainRegion("BM_44", MarkerGenes = mg)
write.csv(BM44_spv,
          paste("results/", "BM44_CellCODE_80mg_4cellTypes.csv", sep = ""))

# Loading AD, CTL gene files to be cell-type corrected -------------------

bm10_geneExp <- read_BR_AD_CTL("BM_10")
bm10_sample_gp <- bm10_geneExp$sample_gp
bm10_geneExp <- subset(bm10_geneExp, select = -c(sample_gp))

bm22_geneExp <- read_BR_AD_CTL("BM_22")
bm22_sample_gp <- bm22_geneExp$sample_gp
bm22_geneExp <- subset(bm22_geneExp, select = -c(sample_gp))

bm36_geneExp <- read_BR_AD_CTL("BM_36")
bm36_sample_gp <- bm36_geneExp$sample_gp
bm36_geneExp <- subset(bm36_geneExp, select = -c(sample_gp))

bm44_geneExp <- read_BR_AD_CTL("BM_44")
...
write.csv(bm10_corrected, paste("results/", "BM10_AD_CTL_cellTypeCorrected.csv", sep = ""))
write.csv(bm22_corrected, paste("results/", "BM22_AD_CTL_cellTypeCorrected.csv", sep = ""))
write.csv(bm36_corrected, paste("results/", "BM36_AD_CTL_cellTypeCorrected.csv", sep = ""))
write.csv(bm44_corrected, paste("results/", "BM44_AD_CTL_cellTypeCorrected.csv", sep = ""))
...
mdata <- read.csv(paste("data/rna_metadata_onlyBAM_noExclude_noDup_Nov2018.csv", sep = ""), stringsAsFactors = FALSE)
...
write.csv(bm10_1022_ad_geneExp_corrected, paste("results/", "ADBM10_BM10BM22_cellTypeCorrected.csv", sep = ""))
write.csv(bm22_1022_ad_geneExp_corrected, paste("results/", "ADBM22_BM10BM22_cellTypeCorrected.csv", sep = ""))
write.csv(bm10_1022_ctl_geneExp_corrected, paste("results/", "CTLBM10_BM10BM22_cellTypeCorrected.csv", sep = ""))
write.csv(bm22_1022_ctl_geneExp_corrected, paste("results/", "CTLBM22_BM10BM22_cellTypeCorrected.csv", sep = ""))

write.csv(bm10_1036_ad_geneExp_corrected, paste("results/", "ADBM10_BM10BM36_cellTypeCorrected.csv", sep = ""))
write.csv(bm36_1036_ad_geneExp_corrected, paste("results/", "ADBM36_BM10BM36_cellTypeCorrected.csv", sep = ""))
write.csv(bm10_1036_ctl_geneExp_corrected, paste("results/", "CTLBM10_BM10BM36_cellTypeCorrected.csv", sep = ""))
write.csv(bm36_1036_ctl_geneExp_corrected, paste("results/", "CTLBM36_BM10BM36_cellTypeCorrected.csv", sep = ""))

write.csv(bm10_1044_ad_geneExp_corrected, paste("results/", "ADBM10_BM10BM44_cellTypeCorrected.csv", sep = ""))
write.csv(bm44_1044_ad_geneExp_corrected, paste("results/", "ADBM44_BM10BM44_cellTypeCorrected.csv", sep = ""))
write.csv(bm10_1044_ctl_geneExp_corrected, paste("results/", "CTLBM10_BM10BM44_cellTypeCorrected.csv", sep = ""))
write.csv(bm44_1044_ctl_geneExp_corrected, paste("results/", "CTLBM44_BM10BM44_cellTypeCorrected.csv", sep = ""))

write.csv(bm22_2236_ad_geneExp_corrected, paste("results/", "ADBM22_BM22BM36_cellTypeCorrected.csv", sep = ""))
write.csv(bm36_2236_ad_geneExp_corrected, paste("results/", "ADBM36_BM22BM36_cellTypeCorrected.csv", sep = ""))
write.csv(bm22_2236_ctl_geneExp_corrected, paste("results/", "CTLBM22_BM22BM36_cellTypeCorrected.csv", sep = ""))
write.csv(bm36_2236_ctl_geneExp_corrected, paste("results/", "CTLBM36_BM22BM36_cellTypeCorrected.csv", sep = ""))

write.csv(bm22_2244_ad_geneExp_corrected, paste("results/", "ADBM22_BM22BM44_cellTypeCorrected.csv", sep = ""))
write.csv(bm44_2244_ad_geneExp_corrected, paste("results/", "ADBM44_BM22BM44_cellTypeCorrected.csv", sep = ""))
write.csv(bm22_2244_ctl_geneExp_corrected, paste("results/", "CTLBM22_BM22BM44_cellTypeCorrected.csv", sep = ""))
write.csv(bm44_2244_ctl_geneExp_corrected, paste("results/", "CTLBM44_BM22BM44_cellTypeCorrected.csv", sep = ""))

write.csv(bm36_3644_ad_geneExp_corrected, paste("results/", "ADBM36_BM36BM44_cellTypeCorrected.csv", sep = ""))
